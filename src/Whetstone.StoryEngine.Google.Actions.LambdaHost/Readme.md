...
WORKDIR /src
COPY ["Whetstone.StoryEngine.Google.Actions.LambdaHost.csproj", "Whetstone.StoryEngine.Google.Actions.LambdaHost/"]
RUN dotnet restore "Whetstone.StoryEngine.Google.Actions.LambdaHost/Whetstone.StoryEngine.Google.Actions.LambdaHost.csproj"

WORKDIR "/src/Whetstone.StoryEngine.Google.Actions.LambdaHost"
COPY . .
RUN dotnet build "Whetstone.StoryEngine.Google.Actions.LambdaHost.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "Whetstone.StoryEngine.Google.Actions.LambdaHost.csproj" \
...
Execute unit tests
```
    cd "Whetstone.StoryEngine.Google.Actions.LambdaHost/test/Whetstone.StoryEngine.Google.Actions.LambdaHost.Tests"
    dotnet test
```

Deploy application
```
    cd "Whetstone.StoryEngine.Google.Actions.LambdaHost/src/Whetstone.StoryEngine.Google.Actions.LambdaHost"
