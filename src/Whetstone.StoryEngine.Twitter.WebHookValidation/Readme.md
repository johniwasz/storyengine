...
Execute unit tests
```
    cd "Whetstone.StoryEngine.Twitter.WebHookValidation/test/Whetstone.StoryEngine.Twitter.WebHookValidation.Tests"
    dotnet test
```

Deploy application
```
    cd "Whetstone.StoryEngine.Twitter.WebHookValidation/src/Whetstone.StoryEngine.Twitter.WebHookValidation"
    dotnet lambda deploy-serverless
```
ngrok http 6000 -host-header="localhost:6000" -subdomain=whetstone
