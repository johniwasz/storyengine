...
Execute unit tests
```
    cd "Whetstone.StoryEngine.SmsCallback/test/Whetstone.StoryEngine.SmsCallback.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "Whetstone.StoryEngine.SmsCallback/src/Whetstone.StoryEngine.SmsCallback"
