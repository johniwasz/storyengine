...
namespace Whetstone.StoryEngine.InboundSmsHandler
{
    ...
    public class StatusUpdateFunction : ClientLambdaBase
    {
        ...
        /// </summary>
        public StatusUpdateFunction() : base()
        {
        ...
        private async Task ProcessMessageAsync(SQSEvent.SQSMessage message, ITwilioStatusCallbackHandler statusCallbackHandler)
        {
            ...
            ILogger<StatusUpdateFunction> statusLogger = Services.GetService<ILogger<StatusUpdateFunction>>();


            if (message == null)
            {
                statusLogger.LogError("SQS event is null");
                return;
            }
        ...
        private TwilioStatusUpdateMessage GetTwilioStatusUpdateMessage(SQSEvent.SQSMessage message)
        {
            ...
            statusLogger.LogInformation($"Validation token for message id {messageId}: {twilioStatusMessage.ValidationToken}");
