...
Execute unit tests
```
    cd "Whetstone.StoryEngine.ApiDispatcher/test/Whetstone.StoryEngine.ApiDispatcher.Tests"
    dotnet test
```

Deploy application
```
    cd "Whetstone.StoryEngine.ApiDispatcher/src/Whetstone.StoryEngine.ApiDispatcher"
