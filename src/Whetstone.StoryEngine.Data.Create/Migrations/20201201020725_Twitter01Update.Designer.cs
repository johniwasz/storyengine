...
namespace Whetstone.StoryEngine.Data.Create.Migrations
{
    ...
    [Migration("20201201020725_Twitter01Update")]
    partial class Twitter01Update
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Whetstone.StoryEngine.Models.Data.DataTwitterApplication", b =>
                {
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
                    ...
                    b.Property<Guid?>("TitleVersionId")
                        .HasColumnName("title_version_id")
                        .HasColumnType("uuid");

                    b.Property<long>("TwitterAppId")
                        .HasColumnName("twitter_app_id")
                    ...
                    b.ToTable("org_twitterapplications");
                });

            modelBuilder.Entity("Whetstone.StoryEngine.Models.Data.DataTwitterCredentials", b =>
                {
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
                    ...
                    b.Property<Guid>("TwitterApplicationId")
                        .HasColumnName("twitterapplication_id")
                        .HasColumnType("uuid");

                    b.HasKey("Id");

                    b.HasIndex("TwitterApplicationId")
                        .IsUnique();

                    b.ToTable("org_twittercredentials");
                });

            modelBuilder.Entity("Whetstone.StoryEngine.Models.Data.DataTwitterSubscription", b =>
                {
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
                    ...
                    b.Property<bool>("IsAutoFollowbackEnabled")
                        .HasColumnName("enable_autofollowback")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Whetstone.StoryEngine.Models.Data.DataTwitterCredentials", b =>
                {
                    b.HasOne("Whetstone.StoryEngine.Models.Data.DataTwitterApplication", "TwitterApplication")
                        .WithOne("TwitterCredentials")
                        .HasForeignKey("Whetstone.StoryEngine.Models.Data.DataTwitterCredentials", "TwitterApplicationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Whetstone.StoryEngine.Models.Data.DataTwitterSubscription", b =>
                {
                    b.HasOne("Whetstone.StoryEngine.Models.Data.DataTwitterApplication", null)
                        .WithMany("TwitterSubscriptions")
                        .HasForeignKey("TwitterApplicationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
