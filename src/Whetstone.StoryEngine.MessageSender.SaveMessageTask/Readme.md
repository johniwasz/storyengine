...
Execute unit tests
```
    cd "Whetstone.StoryEngine.MessageSender.SaveMessageTask/test/Whetstone.StoryEngine.MessageSender.SaveMessageTask.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "Whetstone.StoryEngine.MessageSender.SaveMessageTask/src/Whetstone.StoryEngine.MessageSender.SaveMessageTask"
