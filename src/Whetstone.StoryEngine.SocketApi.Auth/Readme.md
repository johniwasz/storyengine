...
Execute unit tests
```
    cd "Whetstone.StoryEngine.SocketApi.Auth/test/Whetstone.StoryEngine.SocketApi.Auth.Tests"
    dotnet test
```

Deploy application
```
    cd "Whetstone.StoryEngine.SocketApi.Auth/src/Whetstone.StoryEngine.SocketApi.Auth"
