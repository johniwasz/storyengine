...
Execute unit tests
```
    cd "Whetstone.StoryEngine.Reporting.ReportGenerator/test/Whetstone.StoryEngine.Reporting.ReportGenerator.Tests"
    dotnet test
```

Deploy application
```
    cd "Whetstone.StoryEngine.Reporting.ReportGenerator/src/Whetstone.StoryEngine.Reporting.ReportGenerator"
