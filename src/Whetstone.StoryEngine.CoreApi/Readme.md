...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *Sbs.StoryEngine.CoreApi*):

Restore dependencies
```
    cd "Sbs.StoryEngine.CoreApi"
    dotnet restore
```

Execute unit tests
```
    cd "Sbs.StoryEngine.CoreApi/test/Sbs.StoryEngine.CoreApi.Tests"
    dotnet test
```

Deploy application
```
    cd "Sbs.StoryEngine.CoreApi/src/Sbs.StoryEngine.CoreApi"
