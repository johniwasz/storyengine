...
Execute unit tests
```
    cd "Whetstone.Queue.TwiliosStatusUpdate/test/Whetstone.Queue.TwiliosStatusUpdate.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "Whetstone.Queue.TwiliosStatusUpdate/src/Whetstone.Queue.TwiliosStatusUpdate"
